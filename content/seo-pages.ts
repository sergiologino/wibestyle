...
export const seoPages: SeoPageContent[] = [
    ...
    faq: [
      {
        ...
        a: `Приложение выйдет в ${t.appLaunch}. Оставьте заявку ниже — пригласим в ранний доступ и сообщим о старте подбора образов.`,
      },
    ],
    showProductFeatures: true,
    template: "editorial",
  ...
  },
  {
    ...
    faq: [
      {
        q: "Когда появится?",
        a: `Функция в разработке, приложение — в ${t.appLaunch}. Оставьте заявку на ранний тест макияжа.`,
      },
    ],
  ...
  },
  {
    ...
    description: "Ответы про нейропримерку, приватность, маркетплейсы и ранний доступ.",
    h1: "Частые вопросы",
  ...
  },
  {
    ...
    intro: "Данные обрабатываются для нейропримерки и связи по раннему доступу.",
    sections: [
