...
export const onboardingSlides: OnboardingSlide[] = [
  ...
  },
  {
    ...
    text: "Скачанные фото и видео получают QR-код с твоей личной ссылкой. Если человек перейдёт по ней и оформит подписку, тебе начислят дополнительные примерки.",
    image: "/assets/onboarding/slides/result-photo.png",
    video: "/assets/onboarding/slides/result-photo.mp4",
    alt: "Результат примерки, которым можно поделиться в соцсетях",
    tone: "pink",
    bullets: ["личная ссылка в QR", "Instagram и сторис", "мессенджеры и другие соцсети"],
  },
  {
    id: "privacy",
    eyebrow: "Приватность",
  ...
  },
  {
    ...
    title: "Приглашай — примеряй бесплатно",
    text: "Личная ссылка создаётся автоматически после регистрации. Её можно отправить напрямую или оставить в QR-коде на скачанном результате примерки.",
    image: "/assets/onboarding/slides/paywall-photo.webp",
    alt: "Реферальная программа с бонусными виртуальными примерками",
    tone: "pink",
    bullets: ["+3 за месяц", "+15 за год", "начисление после оплаты"],
    footnote: "Приглашать друзей и получать бесплатные примерки могут все пользователи.",
    cta: "trial",
  },
];
