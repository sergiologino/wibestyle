      ...
      <section id="hero" className="hero section-pink" aria-labelledby="hero-title">
        ...
        <div className="hero-layout container-wide">
          ...
          <div className="hero-copy">
            ...
            <p className="lead">
              Виртуальный персональный стилист и нейропримерочная с маркетплейсов. Загрузи свое фото, вставь ссылку с маркетплейса или фото прикида — и посмотри, как платье, пиджак, обувь или целый образ преобразят твой look.
            </p>
