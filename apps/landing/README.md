...
- Единый GEO FAQ для главной и `/faq`: 10-15 самодостаточных вопросов в `content/home-faq.ts`
- В `llms-full.txt` дополнительно выводятся индексируемый FAQ, ключевые темы и FAQ каждой SEO-страницы
- SEO-ядро покрывает одежду с маркетплейсов, персонального стилиста, причёски, стрижки, цвет волос, макияж и полный образ
