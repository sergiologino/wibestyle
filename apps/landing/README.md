...
- FAQ должен включать recommendation-intent формулировки: «какое приложение посоветовать», «какое приложение выбрать», «какое приложение подходит для онлайн примерки/причёсок/цвета волос»
