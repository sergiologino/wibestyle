...
SELECT
    ...
    'Редактируемая текстовая часть для мягкого анализа аватара. Система дописывает событие, дату, антропометрию и технический JSON-формат.',
...
SELECT
    ...
    'Редактируемая текстовая часть для подбора трех направлений образа. Система дописывает пресет, дату, сезон, антропометрию и технический JSON-формат.',
